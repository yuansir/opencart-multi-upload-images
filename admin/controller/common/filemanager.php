...
class ControllerCommonFileManager extends Controller {
     ...
     * @author Allen
     */
    public function mutli_filemanager() {
        $this->load->language('common/filemanager');
        ...
        $this->template = 'common/multi_filemanager.tpl';
    ...
    public function multiimage() {
        ...
        if (isset($this->request->post['image'])) {
            $file = array();
            $file['data'] = $this->model_tool_image->resize($this->request->post['image'], 100, 100);
            $file['rowid'] = $this->request->post['rowid'];
            $this->response->setOutput(json_encode($file));
            /*
              if (isset($this->request->post['image'])) {
...
// Settings
        ...
        $targetDir = DIR_IMAGE . 'data/' . $tmp[0];
