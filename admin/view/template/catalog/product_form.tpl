...
<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            <div id="tabs" class="htabs"><a href="#tab-general"><?php echo $tab_general; ?></a><a href="#tab-data"><?php echo $tab_data; ?></a><a href="#tab-links"><?php echo $tab_links; ?></a><a href="#tab-attribute"><?php echo $tab_attribute; ?></a><a href="#tab-option"><?php echo $tab_option; ?></a><a href="#tab-discount"><?php echo $tab_discount; ?></a><a href="#tab-special"><?php echo $tab_special; ?></a><a href="#tab-image"><?php echo $tab_image; ?></a><a href="#tab-reward"><?php echo $tab_reward; ?></a><a href="#tab-design"><?php echo $tab_design; ?></a><a href="#tab-pupload">批量上传</a></div>
...
<link rel="stylesheet" href="view/javascript/js/jquery-ui/jquery-ui.css" type="text/css" />
<link rel="stylesheet" href="view/javascript/js/jquery.ui.plupload/css/jquery.ui.plupload.css" type="text/css" />
<script type="text/javascript" src="view/javascript/js/plupload.js"></script>
<script type="text/javascript" src="view/javascript/js/plupload.flash.js"></script>
<script type="text/javascript" src="view/javascript/js/plupload.html5.js"></script>
<script type="text/javascript" src="view/javascript/js/plupload.html4.js"></script>
<script type="text/javascript" src="view/javascript/js/jquery.ui.plupload/jquery.ui.plupload.js"></script>
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#uploader").plupload({
            ...
            url : 'index.php?route=common/filemanager/pupload&token=<?php echo $token; ?>',
            ...
            // Flash settings
            flash_swf_url : 'view/javascript/js/plupload.flash.swf'
